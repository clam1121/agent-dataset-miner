"""
ICML论文数据集挖掘主程序
从ICML获取Oral和Spotlight论文，提取数据集信息
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('dataset_miner_icml.log', encoding='utf-8'),
...
class ICMLDatasetMiner:
    """ICML数据集信息挖掘器"""
    
    def __init__(self, output_file: str = "outputs/dataset_icml_results.jsonl"):
        """
        初始化
    ...
    def run(self, year: int = 2025):
        ...
        Args:
            year: ICML年份
        """
        logger.info(f"=== 开始挖掘ICML {year}数据集信息 ===")
        logger.info(f"目标: Oral和Spotlight论文")
...
def main():
    ...
    miner.run(year=2024)  # 默认使用2024，因为2025可能还未发布
